...
struct lightsource{
    array<float,3> pos; // Light-source center (m,m,m)
...
private:
    ...
    float cellGridWid, cellGridHei;   // holds the dimensions for the cell grid - m.
